...
#        self.deleteGlob(snapGlob, 'SNAP_GLOB')
        ...
        self.AUTO_SAVE = 0  ;  self.CAT        = 0  ;  self.CHECKER_BOARD = 0  ;  self.EVENT_LOG   = 0  ;  self.FULL_SCREEN  = 0  ;  self.FRET_BOARD= 0
        ...
        self.VIEWS     = 0  ;  self.TRANSPOSE_A = 0  ;  self.DBG_TAB_TEXT = 0  ;  self.BGC    = 0
        self.idmap        = cOd()
        self.LL           = 0
