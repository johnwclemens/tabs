...
class Just(ivls.Intonation):
    ...
    ####################################################################################################################################################################################################
    def dmpJust(self, k, rf=440, csv=0):
        ...
        slog(f'BGN Just Intonation Series ({k=} {rf=} {self.VS=} {csv=})', p=0, f=ff)
        ...
        slog(f'END Just Intonation Series ({k=} {rf=} {self.VS=} {csv=})', p=0, f=ff)
