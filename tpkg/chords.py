...
#    def fsort(ivals): s = set(ivals)   ;   return sorted(s)
    ...
    OMAP = {
            ...
            'R 2 5'            : (0, [0,2,7],        ['s2']),                     # R 4 b7           [0 5 a]       R 4 5            [0 5 7]
            ...
            'R 4 b7'           : (2, [0,5,10],       ['7','s4','x']),             # R 4 5            [0 5 7]       R 2 5            [0 2 7]
...
#           'R 2 4 6 b7'       : (3, [0,2,5,9,10],   ['13','s2','s4','x']),       # R m3 5 #5 b7     [0 3 7 8 a]   R M3 4 5 6       [0 4 5 7 9]   R b2 m3 4 #5     [0 1 3 5 8]   R 2 M3 5 7       [0 2 4 7 b]
    ...
    ####################################################################################################################################################################################################
            'R b2 m3 M3 b5 6'  : (5, [0,1,3,4,6,9],  ['o','b2','6']),             # R 2 m3 4 #5 7    [0 2 3 5 8 b] R b2 m3 b5 6 b7  [0 1 3 6 9 a] R 2 4 #5 6 7     [0 2 5 8 9 b] R m3 b5 5 6 b7   [0 3 6 7 9 a] R m3 M3 b5 5 6   [0 3 4 6 7 9]
            'R b2 m3 M3 #5 6'  : (5, [0,1,3,4,8,9],  ['m','+','b2','6']),         # R 2 m3 5 #5 7    [0 2 3 7 8 b] R b2 4 b5 6 b7   [0 1 5 6 9 a] R M3 4 #5 6 7    [0 4 5 8 9 b] R b2 M3 4 5 #5   [0 1 4 5 7 8] R m3 M3 b5 5 7   [0 3 4 6 7 b]
            ...
            'R b2 4 b5 #5 b7'  : (4, [0,1,5,6,8,10], ['+','s4','b9']),            # R M3 4 5 6 7     [0 4 5 7 9 b] R b2 m3 4 5 #5   [0 1 3 5 7 8] R 2 M3 b5 5 7    [0 2 4 6 7 b] R 2 M3 4 6 b7    [0 2 4 5 9 a] R 2 m3 5 #5 b7   [0 2 3 7 8 a]
            'R b2 4 b5 6 b7'   : (2, [0,1,5,6,9,10], ['o','s4','13','b9']),       # R M3 4 #5 6 7    [0 4 5 8 9 b] R b2 M3 4 5 #5   [0 1 4 5 7 8] R m3 M3 b5 5 7   [0 3 4 6 7 b] R b2 m3 M3 #5 6  [0 1 3 4 8 9] R 2 m3 5 #5 7    [0 2 3 7 8 b]
            'R b2 4 5 #5 b7'   : (4, [0,1,5,7,8,10], ['s4','b13','b9']),          # R M3 b5 5 6 7    [0 4 6 7 9 b] R 2 m3 4 5 #5    [0 2 3 5 7 8] R b2 m3 4 b5 b7  [0 1 3 5 6 a] R 2 M3 4 6 7     [0 2 4 5 9 b] R 2 m3 5 6 b7    [0 2 3 7 9 a]
            'R 2 m3 4 5 #5'    : (5, [0,2,3,5,7,8],  ['m','2','4','b6']),         # R b2 m3 4 b5 b7  [0 1 3 5 6 a] R 2 M3 4 6 7     [0 2 4 5 9 b] R 2 m3 5 6 b7    [0 2 3 7 9 a] R b2 4 5 #5 b7   [0 1 5 7 8 a] R M3 b5 5 6 7    [0 4 6 7 9 b]
            ...
            'R 2 M3 b5 6 b7'   : (0, [0,2,4,6,9,10], ['13','#11','9']),           #
            'R 2 M3 5 6 7'     : (3, [0,2,4,7,9,11], ['M','13','9','x']),         # R 2 4 5 6 b7     [0 2 5 7 9 a] R m3 4 5 #5 b7   [0 3 5 7 8 a] R 2 M3 4 5 6     [0 2 4 5 7 9] R 2 m3 4 5 b7    [0 2 3 5 7 a] R b2 m3 4 #5 b7  [0 1 3 5 8 a]
            ...
            'R 2 m3 M3 #5 6'   : (3, [0,2,3,4,8,9],   ['m','+','2','6']),         # R b2 2 b5 5 b7   [0 1 2 6 7 a] R b2 4 b5 6 7    [0 1 5 6 9 b] R M3 4 #5 b7 7   [0 4 5 8 a b] R b2 M3 b5 5 #5  [0 1 4 6 7 8] R m3 4 b5 5 7    [0 3 5 6 7 b]
