...
# Consider swapping blanks with values for 'e=1.955' eps col in IVals Table for 1==0 & i==len-1
'''
...
#    blanks 2 tables above verses values 2 tables below:
j j*100 i Iv  c     k       d       e       c`   Iv  c     k       d       e       c`  
...
'''
# Also consider c/t current of total counts AND trim 2 spaces at end of hdr (above verses below)
'''
