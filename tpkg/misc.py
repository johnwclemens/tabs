...
# Pythagorean Intervals dmpIvals(): # need to use RatA / RatB for Rat1 when ni==2 and x=9 (width too small for 6 digit / 6 digits) need separate values on separate lines
# Current
########################################################################################################################################################################################################
'''
...
########################################################################################################################################################################################################
# Pythagorean Intervals dmpIvals(): # need to use RatA / RatB for Rat1 when ni==2 and x=9 (width too small for 6 digit / 6 digits) need separate values on separate lines
# However, that will triple the number of lines for that section of the table (from 1-12 lines to 3-36 lines)
# Perhaps borrowing spaces from the next (blank) field will suffice?  Like below
########################################################################################################################################################################################################
'''
        ---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------|---------
0 51 E♭[   1/1   |         |2187/2048|         |   9/8   |         |19683/16384|       |  81/64  |         |177147/131072|     | 729/512 |         |   3/2   |         |6561/4096|         |  27/16  |         |59049/32768|       | 243/128 |   2/1   ]
