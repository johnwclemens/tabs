...
def on_key_press(tobj, symb, mods, dbg=1):
    ...
    elif k == 'S' and isAltShf(d, m):      cmd = cmds.ShiftTabsCmd(    tobj, '&^S')                 ;  cmd.do() #fixme 11/18/23
    ...
    elif k == 'W' and isAltShf(d, m):      cmd = cmds.SwapTabCmd(      tobj, '&^S', txt=Z)          ;  cmd.do() #fixme 11/18/23
