...
echo python tabs.py -i 1 1 1 6 -n 1 2 10 6 -o -J 4 -S 0 -f test $path/$name.$ext
python      tabs.py -i 1 1 1 6 -n 1 2 10 6 -o -J 4 -S 0 -f test $path/$name.$ext
#echo python tabs.py -i 1 1 1 6 -n 1 2 10 6 -o -J 4 -S 0 -f test | iconv -f cp1252 -t UTF-8 &> $path/$name.$ext
#python      tabs.py -i 1 1 1 6 -n 1 2 10 6 -o -J 4 -S 0 -f test | iconv -f cp1252 -t UTF-8 &> $path/$name.$ext
...
#python tabs.py -i 1 1 1 6 -n 1 2 10 6 -o -J 4 -S 0 1 3 -f test
