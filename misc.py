...
class Chord(object):
    ...
    def updateImap(self, im, name, chunks, dbg=0, dbg2=0):
        intervals = list(im.keys())    ;   notes = list(im.values())     ;   rank = -1
        ...
        if   self.limap and self.limap[0]: chordName = self.limap[0][2]  ;  chunks = self.limap[0][3]
    ...
    def getChordName(self, p, l, c, dbg=1, dbg2=0):
        ...
        if dbg2:
            for i, m in enumerate(self.limap):
                self.log(tabs.FMTR.format(f'limap {i+1} [ <{m[2]:<9}>  {tabs.fmtl(m[0], 2, "<", d1, d2):17} {tabs.fmtl(m[1], 2, "<", d1, d2):17} ] {tabs.fmtl(m[3])}'))
        return chordName, chunks
...
#        self.log(ind=0)
    ...
    def toggleChordName(self, key, rev=0, dbg=0):
...
#            else:      self.log(f'{tabs.fmtl(aa2[j],   d1="" if j else "|", d2="|")}', ind=0, end='') #   if j<len(aa2) else '  ')
    ...
    OMAP = {
            ...
            'R b7 7'           : (0, [0,10,11],      ['M','#','13']),           # R b2 2           [0 1 2]       R b2 7           [0 1 b]
            ...
            'R b2 4 b7'        : (1, [0,1,5,10],     ['b9','s4','x']),          # R M3 6 7         [0 4 9 b]     R 4 5 #5         [0 5 7 8]     R 2 m3 5         [0 2 3 7]
            ...
            'R b2 b5 b7'       : (3, [0,1,6,10],     ['o','b9','y']),           # R 4 6 7          [0 5 9 b]     R M3 b5 5        [0 4 6 7]     R 2 m3 #5        [0 2 3 8]
            ...
            'R b2 b7 7'        : (1, [0,1,10,11],    ['M','#','13','b9','xy']), # R 6 b7 7         [0 9 a b]     R b2 2 m3        [0 1 2 3]     R b2 2 7         [0 1 2 b]
            ...
            'R 2 m3 5'         : (2, [0,2,3,7],      ['m','2']),                # R b2 4 b7        [0 1 5 a]     R M3 6 7         [0 4 9 b]     R 4 5 #5         [0 5 7 8]
            'R 2 m3 #5'        : (2, [0,2,3,8],      ['m','2','#5']),           # R b2 b5 b7       [0 1 6 a]     R 4 6 7          [0 5 9 b]     R M3 b5 5        [0 4 6 7]
            ...
            'R 2 b5 b7'        : (1, [0,2,6,10],     ['07','s2']),              # R M3 #5 b7       [0 4 8 a]     R M3 b5 #5       [0 4 6 8]     R 2 M3 #5        [0 2 4 8]
            ...
            'R m3 b7 7'        : (1, [0,3,10,11],    ['m','M','#','13','x']),   # R 5 #5 6         [0 7 8 9]     R b2 2 4         [0 1 2 5]     R b2 M3 7        [0 1 4 b]
            ...
            'R M3 b5 5'        : (0, [0,4,6,7],      ['#4']),                   # R 2 m3 #5        [0 2 3 8]     R b2 b5 b7       [0 1 6 a]     R 4 6 7          [0 5 9 b]
            ...
            'R M3 b7 7'        : (1, [0,4,10,11],    ['M','#','13','x']),       # R b5 5 #5        [0 6 7 8]     R b2 2 b5        [0 1 2 6]     R b2 4 7         [0 1 5 b]
            ...
            'R 4 #5 7'         : (1, [0,5,8,11],     ['+','M','s4']),           # R m3 b5 5        [0 3 6 7]     R m3 M3 6        [0 3 4 9]     R b2 b5 6        [0 1 6 9]
            ...
            'R 4 b7 7'         : (1, [0,5,10,11],    ['M','#','13','s4','x']),  # R 4 b5 5         [0 5 6 7]     R b2 2 5         [0 1 2 7]     R b2 b5 7        [0 1 6 b]
            ...
            'R b5 b7 7'        : (1, [0,6,10,11],    ['o','M','#','13']),       # R M3 4 b5        [0 4 5 6]     R b2 2 #5        [0 1 2 8]     R b2 5 7         [0 1 7 b]
            ...
            'R 5 b7 7'         : (1, [0,7,10,11],    ['M','#','13','y']),       # R m3 M3 4        [0 3 4 5]     R b2 2 6         [0 1 2 9]     R b2 #5 7        [0 1 8 b]
            'R #5 6 b7'        : (1, [0,8,9,10],     ['+','13','y']),           # R b2 2 M3        [0 1 2 4]     R b2 m3 7        [0 1 3 b]     R 2 b7 7         [0 2 a b]
            'R #5 b7 7'        : (2, [0,8,10,11],    ['+','M','#','13','y']),   # R 2 m3 M3        [0 2 3 4]     R b2 2 b7        [0 1 2 a]     R b2 6 7         [0 1 9 b]
            'R 6 b7 7'         : (2, [0,9,10,11],    ['M','#','13','6','xy']),  # R b2 2 m3        [0 1 2 3]     R b2 2 7         [0 1 2 b]     R b2 b7 7        [0 1 a b]
            ...
            'R m3 M3 b5 7'     : (0, [0,3,4,6,11],   ['M','#','11','#9','x']),  # R b2 m3 #5 6     [0 1 3 8 9]   R 2 5 #5 7       [0 2 7 8 b]   R 4 b5 6 b7      [0 5 6 9 a]   R b2 M3 4 5      [0 1 4 5 7]
            ...
            'R M3 5 b7 7'      : (0, [0,4,7,10,11],  ['M','#','13']),           # R m3 b5 5 #5     [0 3 6 7 8]   R m3 M3 4 6      [0 3 4 5 9]   R b2 2 b5 6      [0 1 2 6 9]   R b2 4 #5 7      [0 1 5 8 b]
            'R 4 b5 #5 b7'     : (3, [0,5,6,8,10],   ['o','+','7','s4']),       # R b2 m3 4 5      [0 1 3 5 7]   R 2 M3 b5 7      [0 2 4 6 b]   R 2 M3 6 b7      [0 2 4 9 a]   R 2 5 #5 b7      [0 2 7 8 a]
            'R 4 b5 #5 7'      : (1, [0,5,6,8,11],   ['M','o','+','7','s4']),   # R b2 m3 b5 5     [0 1 3 6 7]   R 2 4 b5 7       [0 2 5 6 b]   R m3 M3 6 b7     [0 3 4 9 a]   R b2 b5 5 6      [0 1 6 7 9]
