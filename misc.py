...
#            else:      self.log(f'{tabs.fmtl(aa2[j],   d1="" if j else "|", d2="|")}', ind=0, end='') #   if j<len(aa2) else '  ')
    ...
    OMAP = {
            ...
            'R 2 m3 #5 7'      : (1, [0,2,3,8,11],   ['+','M','9','x']),        # R b2 b5 6 b7     [0 1 6 9 a]   R 4 #5 6 7       [0 5 8 9 b]   R m3 M3 b5 5     [0 3 4 6 7]   R b2 m3 M3 6     [0 1 3 4 9]
            ...
            'R 4 #5 6 7'       : (3, [0,5,8,9,11],   ['+','M','13','s4']),      # R m3 M3 b5 5     [0 3 4 6 7]   R b2 m3 M3 6     [0 1 3 4 9]   R 2 m3 #5 7      [0 2 3 8 b]   R b2 b5 6 b7     [0 1 6 9 a]
