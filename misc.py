...
#            else:      self.log(f'{tabs.fmtl(aa2[j],   d1="" if j else "|", d2="|")}', ind=0, end='') #   if j<len(aa2) else '  ')
    ...
    def _dumpOMAP(self, catfile=None):
        ...
        omap = self.OMAP
        setMap = {}   ;   r = {}   ;   order = -1  # len(self.tobj.stringNumbs) + 1
    ...
    OMAP = {
        ...
        'R M3 b5 7'        : (0, [0,4,6,11],     ['M','#','11','x']),                         # R 2 5 #5         [0 2 7 8]     R 4 b5 b7        [0 5 6 a]     R b2 4 5         [0 1 5 7]
        ...
        'R 4 b5 b7'        : (1, [0,5,6,10],     ['#','11','s4']),                         # R b2 4 5         [0 1 5 7]     R M3 b5 7        [0 4 6 b]     R 2 5 #5         [0 2 7 8]
        ...
        'R b2 2 b5 6'      : (7, [0,1,2,6,9],    []),                         # R b2 4 #5 7      [0 1 5 8 b]   R M3 5 b7 7      [0 4 7 a b]   R m3 b5 5 #5     [0 3 6 7 8]   R m3 M3 4 6      [0 3 4 5 9]
        ...
        'R b2 m3 b5 6'     : (7, [0,1,3,6,9],    []),                         # R 2 4 #5 7       [0 2 5 8 b]   R m3 b5 6 b7     [0 3 6 9 a]   R m3 b5 5 6      [0 3 6 7 9]   R m3 M3 b5 6     [0 3 4 6 9]
        ...
        'R b2 m3 5 6'      : (7, [0,1,3,7,9],    []),                         # R 2 b5 #5 7      [0 2 6 8 b]   R M3 b5 6 b7     [0 4 6 9 a]   R 2 4 b5 #5      [0 2 5 6 8]   R m3 M3 b5 b7    [0 3 4 6 a]
            'R b2 m3 5 b7'     : (1, [0,1,3,7,10],   ['m','b9']),               # R 2 b5 6 7       [0 2 6 9 b]   R M3 5 6 b7      [0 4 7 9 a]   R m3 4 b5 #5     [0 3 5 6 8]   R 2 m3 4 6       [0 2 3 5 9]
        'R b2 m3 #5 6'     : (7, [0,1,3,8,9],    []),                         # R 2 5 #5 7       [0 2 7 8 b]   R 4 b5 6 b7      [0 5 6 9 a]   R b2 M3 4 5      [0 1 4 5 7]   R m3 M3 b5 7     [0 3 4 6 b]
        ...
        'R b2 M3 4 5'      : (7, [0,1,4,5,7],    []),                         # R m3 M3 b5 7     [0 3 4 6 b]   R b2 m3 #5 6     [0 1 3 8 9]   R 2 5 #5 7       [0 2 7 8 b]   R 4 b5 6 b7      [0 5 6 9 a]
        ...
        'R b2 4 5 b7'      : (7, [0,1,5,7,10],   []),                         # R M3 b5 6 7      [0 4 6 9 b]   R 2 4 5 #5       [0 2 5 7 8]   R m3 4 b5 b7     [0 3 5 6 a]   R 2 m3 5 6       [0 2 3 7 9]
            'R b2 4 #5 b7'     : (3, [0,1,5,8,10],   ['b9','s4','+']),          # R M3 5 6 7       [0 4 7 9 b]   R m3 4 5 #5      [0 3 5 7 8]   R 2 M3 4 6       [0 2 4 5 9]   R 2 m3 5 b7      [0 2 3 7 a]
        'R b2 4 #5 7'      : (7, [0,1,5,8,11],   []),                         # R M3 5 b7 7      [0 4 7 a b]   R m3 b5 5 #5     [0 3 6 7 8]   R m3 M3 4 6      [0 3 4 5 9]   R b2 2 b5 6      [0 1 2 6 9]
        ...
        'R 2 m3 5 6'       : (7, [0,2,3,7,9],    []),                         # R b2 4 5 b7      [0 1 5 7 a]   R M3 b5 6 7      [0 4 6 9 b]   R 2 4 5 #5       [0 2 5 7 8]   R m3 4 b5 b7     [0 3 5 6 a]
        ...
        'R 2 4 b5 #5'      : (7, [0,2,5,6,8],    []),                         # R m3 M3 b5 b7    [0 3 4 6 a]   R b2 m3 5 6      [0 1 3 7 9]   R 2 b5 #5 7      [0 2 6 8 b]   R M3 b5 6 b7     [0 4 6 9 a]
            'R 2 4 b5 6'       : (3, [0,2,5,6,9],    ['s2','s4','o','6']),      # R m3 M3 5 b7     [0 3 4 7 a]   R b2 M3 5 6      [0 1 4 7 9]   R m3 b5 #5 7     [0 3 6 8 b]   R m3 4 #5 6      [0 3 5 8 9]
        'R 2 4 5 #5'       : (7, [0,2,5,7,8],    []),                         # R m3 4 b5 b7     [0 3 5 6 a]   R 2 m3 5 6       [0 2 3 7 9]   R b2 4 5 b7      [0 1 5 7 a]   R M3 b5 6 7      [0 4 6 9 b]
        ...
        'R 2 4 #5 7'       : (7, [0,2,5,8,11],   []),                         # R m3 b5 6 b7     [0 3 6 9 a]   R m3 b5 5 6      [0 3 6 7 9]   R m3 M3 b5 6     [0 3 4 6 9]   R b2 m3 b5 6     [0 1 3 6 9]
        ...
        'R 2 b5 #5 7'      : (7, [0,2,6,8,11],   []),                         # R M3 b5 6 b7     [0 4 6 9 a]   R 2 4 b5 #5      [0 2 5 6 8]   R m3 M3 b5 b7    [0 3 4 6 a]   R b2 m3 5 6      [0 1 3 7 9]
        ...
        'R 2 5 #5 7'       : (7, [0,2,7,8,11],   []),                         # R 4 b5 6 b7      [0 5 6 9 a]   R b2 M3 4 5      [0 1 4 5 7]   R m3 M3 b5 7     [0 3 4 6 b]   R b2 m3 #5 6     [0 1 3 8 9]
        ...
        'R m3 M3 4 6'      : (7, [0,3,4,5,9],    []),                         # R b2 2 b5 6      [0 1 2 6 9]   R b2 4 #5 7      [0 1 5 8 b]   R M3 5 b7 7      [0 4 7 a b]   R m3 b5 5 #5     [0 3 6 7 8]
            'R m3 M3 b5 #5'    : (3, [0,3,4,6,8],    ['#2','#4','#5']),         # R b2 m3 4 6      [0 1 3 5 9]   R 2 M3 #5 7      [0 2 4 8 b]   R 2 b5 6 b7      [0 2 6 9 a]   R M3 5 #5 b7     [0 4 7 8 a]
        'R m3 M3 b5 6'     : (7, [0,3,4,6,9],    []),                         # R b2 m3 b5 6     [0 1 3 6 9]   R 2 4 #5 7       [0 2 5 8 b]   R m3 b5 6 b7     [0 3 6 9 a]   R m3 b5 5 6      [0 3 6 7 9]
        'R m3 M3 b5 b7'    : (7, [0,3,4,6,10],   []),                         # R b2 m3 5 6      [0 1 3 7 9]   R 2 b5 #5 7      [0 2 6 8 b]   R M3 b5 6 b7     [0 4 6 9 a]   R 2 4 b5 #5      [0 2 5 6 8]
        'R m3 M3 b5 7'     : (7, [0,3,4,6,11],   []),                         # R b2 m3 #5 6     [0 1 3 8 9]   R 2 5 #5 7       [0 2 7 8 b]   R 4 b5 6 b7      [0 5 6 9 a]   R b2 M3 4 5      [0 1 4 5 7]
        ...
        'R m3 4 b5 b7'     : (7, [0,3,5,6,10],   []),                         # R 2 m3 5 6       [0 2 3 7 9]   R b2 4 5 b7      [0 1 5 7 a]   R M3 b5 6 7      [0 4 6 9 b]   R 2 4 5 #5       [0 2 5 7 8]
        ...
        'R m3 b5 5 #5'     : (7, [0,3,6,7,8],    []),                         # R m3 M3 4 6      [0 3 4 5 9]   R b2 2 b5 6      [0 1 2 6 9]   R b2 4 #5 7      [0 1 5 8 b]   R M3 5 b7 7      [0 4 7 a b]
        'R m3 b5 5 6'      : (7, [0,3,6,7,9],    []),                         # R m3 M3 b5 6     [0 3 4 6 9]   R b2 m3 b5 6     [0 1 3 6 9]   R 2 4 #5 7       [0 2 5 8 b]   R m3 b5 6 b7     [0 3 6 9 a]
        ...
        'R m3 b5 6 b7'     : (7, [0,3,6,9,10],   []),                         # R m3 b5 5 6      [0 3 6 7 9]   R m3 M3 b5 6     [0 3 4 6 9]   R b2 m3 b5 6     [0 1 3 6 9]   R 2 4 #5 7       [0 2 5 8 b]
        ...
        'R M3 b5 6 b7'     : (7, [0,4,6,9,10],   []),                         # R 2 4 b5 #5      [0 2 5 6 8]   R m3 M3 b5 b7    [0 3 4 6 a]   R b2 m3 5 6      [0 1 3 7 9]   R 2 b5 #5 7      [0 2 6 8 b]
        'R M3 b5 6 7'      : (7, [0,4,6,9,11],   []),                         # R 2 4 5 #5       [0 2 5 7 8]   R m3 4 b5 b7     [0 3 5 6 a]   R 2 m3 5 6       [0 2 3 7 9]   R b2 4 5 b7      [0 1 5 7 a]
        ...
        'R M3 5 b7 7'      : (7, [0,4,7,10,11],  []),                         # R m3 b5 5 #5     [0 3 6 7 8]   R m3 M3 4 6      [0 3 4 5 9]   R b2 2 b5 6      [0 1 2 6 9]   R b2 4 #5 7      [0 1 5 8 b]
        ...
        'R 4 b5 6 b7'      : (7, [0,5,6,9,10],   []),                         # R b2 M3 4 5      [0 1 4 5 7]   R m3 M3 b5 7     [0 3 4 6 b]   R b2 m3 #5 6     [0 1 3 8 9]   R 2 5 #5 7       [0 2 7 8 b]
        ...
        'R b2 m3 M3 #5 6'  : (7, [0,1,3,4,8,9],  []),                         # R 2 m3 5 #5 7    [0 2 3 7 8 b] R b2 4 b5 6 b7   [0 1 5 6 9 a] R M3 4 #5 6 7    [0 4 5 8 9 b] R b2 M3 4 5 #5   [0 1 4 5 7 8] R m3 M3 b5 5 7   [0 3 4 6 7 b]
        ...
        'R b2 M3 4 5 #5'   : (7, [0,1,4,5,7,8],  []),                         # R m3 M3 b5 5 7   [0 3 4 6 7 b] R b2 m3 M3 #5 6  [0 1 3 4 8 9] R 2 m3 5 #5 7    [0 2 3 7 8 b] R b2 4 b5 6 b7   [0 1 5 6 9 a] R M3 4 #5 6 7    [0 4 5 8 9 b]
        ...
        'R b2 4 b5 6 b7'   : (7, [0,1,5,6,9,10], []),                         # R M3 4 #5 6 7    [0 4 5 8 9 b] R b2 M3 4 5 #5   [0 1 4 5 7 8] R m3 M3 b5 5 7   [0 3 4 6 7 b] R b2 m3 M3 #5 6  [0 1 3 4 8 9] R 2 m3 5 #5 7    [0 2 3 7 8 b]
        ...
        'R 2 m3 5 #5 7'    : (7, [0,2,3,7,8,11], []),                         # R b2 4 b5 6 b7   [0 1 5 6 9 a] R M3 4 #5 6 7    [0 4 5 8 9 b] R b2 M3 4 5 #5   [0 1 4 5 7 8] R m3 M3 b5 5 7   [0 3 4 6 7 b] R b2 m3 M3 #5 6  [0 1 3 4 8 9]
        ...
        'R m3 M3 b5 5 7'   : (7, [0,3,4,6,7,11], []),                         # R b2 m3 M3 #5 6  [0 1 3 4 8 9] R 2 m3 5 #5 7    [0 2 3 7 8 b] R b2 4 b5 6 b7   [0 1 5 6 9 a] R M3 4 #5 6 7    [0 4 5 8 9 b] R b2 M3 4 5 #5   [0 1 4 5 7 8]
        ...
        'R M3 4 #5 6 7'    : (7, [0,4,5,8,9,11], []),                         # R b2 M3 4 5 #5   [0 1 4 5 7 8] R m3 M3 b5 5 7   [0 3 4 6 7 b] R b2 m3 M3 #5 6  [0 1 3 4 8 9] R 2 m3 5 #5 7    [0 2 3 7 8 b] R b2 4 b5 6 b7   [0 1 5 6 9 a]
