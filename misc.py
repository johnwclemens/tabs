...
#            else:      self.log(f'{tabs.fmtl(aa2[j],   d1="" if j else "|", d2="|")}', ind=0, end='') #   if j<len(aa2) else '  ')
    ...
    OMAP = {
            ...
            'R b2 m3 7'        : (0, [0,1,3,11],     ['m','b9','x']),           # R 2 b7 7         [0 2 a b]     R #5 6 b7        [0 8 9 a]     R b2 2 M3        [0 1 2 4]
            ...
            'R 4 b5 7'         : (0, [0,5,6,11],     ['o','7','s4']),           # R b2 b5 5        [0 1 6 7]     R 4 b5 7         [0 5 6 b]     R b2 b5 5        [0 1 6 7]
            ...
            'R 2 b5 #5 7'      : (4, [0,2,6,8,11],   ['o','+','7','s2']),       # R M3 b5 6 b7     [0 4 6 9 a]   R 2 4 b5 #5      [0 2 5 6 8]   R m3 M3 b5 b7    [0 3 4 6 a]   R b2 m3 5 6      [0 1 3 7 9]
            ...
            'R 4 b5 #5 7'      : (1, [0,5,6,8,11],   ['o','+','7','s4']),       # R b2 m3 b5 5     [0 1 3 6 7]   R 2 4 b5 7       [0 2 5 6 b]   R m3 M3 6 b7     [0 3 4 9 a]   R b2 b5 5 6      [0 1 6 7 9]
