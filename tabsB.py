...
#        self.log(f'{self.fmtKbkE()}')
        ...
        elif t == 'S' and self.isShift():             self.saveDataFile(f'^{t}',    self.dataPath1)
...
#        if KK in self.SS: self.setChord(imap, p, l, c)
        if dbg: self.log(f'END {kk=}    {text=}') #{len(imap)=}')
    ####################################################################################################################################################################################################
